      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8">
        <div className="col-span-4">
          ...
          <p className="pb-2">
            ...
            -- products under "featured products" can be added to the cart, and
            you can get to the cart page by clicking on the cart icon in the top
            right.
          </p>
          <p className="pb-2">
            The site is partially responsive, and I'd like to come back at some
            point to make it fully responsive. I also tried to implement an
            "Added to Cart" popup which would appear on the bottom left every
            time a product is added to the cart, but I haven't quite figured out
            how to make it fully functional. I've left the code in there
            commented out so I can come back to it later.
          </p>
          <p>
            ...
            part). If I were to build the project again I'd be more consistent
            in my use of flexbox and CSS grids.
          </p>
          <Link
