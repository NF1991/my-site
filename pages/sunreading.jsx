      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <p className="pb-2">
            ...
            fortune telling book exists. It is a simple project that allows you
          ...
          <p>
            The draw button is disabled once you have drawn nine cards, and the
            reset button allows you start again. Also, each card picked is
            listed so you do not forget what you got. This was a fun project,
            ...
            listed. If I were to come back to this project, I would focus on
